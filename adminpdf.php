...
$pdf->Ln();
  $pdf->Image("img/Maseno-University-Logo.png",140,3,20);
$pdf->Ln(); 
//Cell (width,height,text,border,endline,[align])
// $pdf->Cell(50,5,'Image',1,0);

$pdf->Cell(43,5,'Student',1,0);
$pdf->Cell(31,5,'RegNo',1,0);
$pdf->Cell(20,5,'Gender',1,0);
$pdf->Cell(13,5,'Age',1,0);
$pdf->Cell(25,5,'Phone',1,0);
$pdf->Cell(78,5,'Course',1,0);
...
if( isset($_SESSION['regNo']  ) ) {
    ...
    $pdf->Cell(70,5,"Printed on :",0,0,"R");
